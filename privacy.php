  ...
  <div class="d-flex flex-column my-5 inner-wrapper justify-contents-center container">
    <div class="row">
      <div class="col-md-12 text-left mx-auto">
        <h2>Privacy Policy for StudentHired</h2>

        <p>At StudentHired, accessible from https://www.studenthired.com, one of our main priorities is the privacy of
          our visitors. This Privacy Policy document contains types of information that is collected and recorded by
          StudentHired and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
          regards to the information that they shared and/or collect in StudentHired. This policy is not applicable to
        ...
        <p>StudentHired follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>Like any other website, StudentHired uses 'cookies'. These cookies are used to store information including
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of StudentHired.
        </p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
          used in their respective advertisements and links that appear on StudentHired, which are sent directly to
        ...
        <p>Note that StudentHired has no access to or control over these cookies that are used by third-party
          advertisers.</p>

        <h3>Third Party Privacy Policies</h3>

        <p>StudentHired's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>StudentHired does not knowingly collect any Personal Identifiable Information from children under the age of
