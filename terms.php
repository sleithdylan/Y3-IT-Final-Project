  ...
  <div class="d-flex flex-column my-5 inner-wrapper justify-contents-center container">
    <div class="row">
      <div class="col-md-12 text-left mx-auto">
        ...
        <p>Welcome to StudentHired!</p>

        <p>These terms and conditions outline the rules and regulations for the use of StudentHired's Website, located
          at https://www.studenthired.com.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
          StudentHired if you do not agree to take all of the terms and conditions stated on this page. Our Terms and
        ...
        <p>We employ the use of cookies. By accessing StudentHired, you agreed to use cookies in agreement with the
          StudentHired's Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, StudentHired and/or its licensors own the intellectual property rights for all
          material on StudentHired. All intellectual property rights are reserved. You may access this from StudentHired
          for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from StudentHired</li>
          <li>Sell, rent or sub-license material from StudentHired</li>
          <li>Reproduce, duplicate or copy material from StudentHired</li>
          <li>Redistribute content from StudentHired</li>
        </ul>

        <p>This Agreement shall begin on the date hereof.</p>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. StudentHired does not filter, edit, publish or review Comments prior to their presence
          on the website. Comments do not reflect the views and opinions of StudentHired,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, StudentHired shall not be liable for the Comments or for any liability, damages
        ...
        <p>StudentHired reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant StudentHired a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
          ...
          StudentHired; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
          you must inform us by sending an e-mail to StudentHired. Please include your name, your organization name,
        ...
        <p>No use of StudentHired's logo or other artwork will be allowed for linking absent a trademark license
          agreement.</p>
